...
export function useThemeVars(theme?: DatePickerTheme | ThemePreset): CSSProperties {
  return useMemo(() => {
...
export function getThemeVars(theme?: DatePickerTheme | ThemePreset): CSSProperties {
  const resolved = resolveTheme(theme)
  return themeToCSSVars(resolved) as CSSProperties
}